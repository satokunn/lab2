...
sys_lstat, sys_readlink, sys_uselib,sys_execve2,sys_getdents,sys_pipe2,sys_sleep,sys_getcwd,sys_init_graphics,sys_get_message,sys_timer_creater,sys_paint };
